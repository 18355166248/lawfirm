...
var baidumap = function () {
  ...
  function addNewMarker(lng, lat) {
    ...
    markerArr = { title: '', content: add, point: lng + "|" + lat, isOpen: 0, icon: { w: sw, h: sh, l: 0, t: 0, x: 0, lb: 40, oftx: 0, ofty: 70 } };
    map.clearOverlays();
  ...
  function createIcon(json) {
    var sicon = '';
    if (!os.pc || $(window).width() < 768) {
      sicon = 'images/common/site2.png';
    } else {
      sicon = 'images/common/site.png';
    }
    var icon = new BMap.Icon(sicon, new BMap.Size(json.w, json.h),
      {
